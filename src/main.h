...
inline int64_t GetMstrNodCollateral(int nHeight) {
	...
	else if (nHeight < 7500 && nHeight > 5000) { 
		return 1000000;
	}
	else if (nHeight < 10000 && nHeight > 7500) { 
		return 1000000;
	}
	...
	else if (nHeight < 135000 && nHeight > 120000) { 
		return 1000000;
	}
	else if (nHeight < 150000 && nHeight > 135000) { 
		return 1000000;
	}
	else if (nHeight < 165000 && nHeight > 150000) { 
		return 1000000;
	}
	else if (nHeight < 180000 && nHeight > 165000) { 
		return 1000000;
	}
	...
	else if (nHeight < 3000000 && nHeight > 500000) { 
		return 1000000;
	}
