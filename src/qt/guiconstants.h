...
#define QAPP_ORG_NAME "Betller"
#define QAPP_ORG_DOMAIN "betllernetwork.io"
#define QAPP_APP_NAME_DEFAULT "Betller-Qt"
#define QAPP_APP_NAME_TESTNET "Betller-Qt-testnet"
