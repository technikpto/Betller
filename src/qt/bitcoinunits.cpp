...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(BTLLR);
    unitlist.append(mBTLLR);
    unitlist.append(uBTLLR);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case BTLLR:
        return QString("BTLLR");
    case mBTLLR:
        return QString("mBTLLR");
    case uBTLLR:
        return QString::fromUtf8("uBTLLR");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit, bool isZpiv)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case BTLLR:
            return z + QString("BTLLR");
        case mBTLLR:
            return z + QString("mBTLLR");
        case uBTLLR:
            return z + QString::fromUtf8("μBTLLR");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case BTLLR:
            return z + QString("tBTLLR");
        case mBTLLR:
            return z + QString("mtBTLLR");
        case uBTLLR:
            return z + QString::fromUtf8("μtBTLLR");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BTLLR:
            return QString("BTLLR");
        case mBTLLR:
            return QString("Milli-BTLLR (1 / 1" THIN_SP_UTF8 "000)");
        case uBTLLR:
            return QString("Micro-BTLLR (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
