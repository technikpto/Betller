/* src/config/betller-config.h.  Generated from betller-config.h.in by configure.  */
/* src/config/betller-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BTLLR_CONFIG_H

#define BTLLR_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/BetllerOfficial/Betller/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Betller"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Betller 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "betller"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://www.betllernetwork.io/"
