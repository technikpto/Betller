...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Betller server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"betller", "listmasternodes", &listmasternodes, true, true, false},
        {"betller", "getmasternodecount", &getmasternodecount, true, true, false},
        {"betller", "masternodeconnect", &masternodeconnect, true, true, false},
        {"betller", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"betller", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"betller", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"betller", "masternodecurrent", &masternodecurrent, true, true, false},
        {"betller", "masternodedebug", &masternodedebug, true, true, false},
        {"betller", "startmasternode", &startmasternode, true, true, false},
        {"betller", "createmasternodekey", &createmasternodekey, true, true, false},
        {"betller", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"betller", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"betller", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"betller", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"betller", "getmasternodescores", &getmasternodescores, true, true, false},
        {"betller", "preparebudget", &preparebudget, true, true, false},
        {"betller", "submitbudget", &submitbudget, true, true, false},
        {"betller", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"betller", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"betller", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"betller", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"betller", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"betller", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"betller", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"betller", "checkbudgets", &checkbudgets, true, true, false},
        {"betller", "mnsync", &mnsync, true, true, false},
        {"betller", "spork", &spork, true, true, false},
...
{
    return "> betller-cli " + methodname + " " + args + "\n";
}
