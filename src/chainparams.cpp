...
{
    const char* pszTimestamp = "Betller - Sun June 7th 2020 - Remapper";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("00000d3efc052e45acd77ea1e296d127cd93a44fd70a58fb9137c19847e37d60"))
;
...
public:
    CMainParams()
    {
        ...
        strNetworkID = "main";
        genesis = CreateGenesisBlock(1595173503, 165610, 0x1e0ffff0, 1, 0 * COIN);
    	consensus.hashGenesisBlock = genesis.GetHash();
		assert(consensus.hashGenesisBlock == uint256("00000d3efc052e45acd77ea1e296d127cd93a44fd70a58fb9137c19847e37d60"));
        assert(genesis.hashMerkleRoot == uint256("d50884e65301ccad34a71b5f3cf667aaecb8e6f2b95918834c9bfe3fdd98477d"));
        ...
        consensus.ZC_TimeStart = 1538323044;        // October 17, 2017 4:30:00 AM
        ...
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 125);     // starting with 'C' - Cold staking address
        ...
        strMasternodePoolDummyAddress = "B6z55njuk7N3PBifZXWMPRtCoN3akoCm7c";
    }
